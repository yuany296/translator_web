export function installReaderState(runtime) {
  ...
  const EMBEDDED_MAX_RENDER_SCALE = 4;
  runtime.EMBEDDED_MAX_RENDER_SCALE = EMBEDDED_MAX_RENDER_SCALE;
  ...
  // Safety scale: reduce from 0.9 → 0.96 (less aggressive trimming)
  const BUBBLE_FONT_SAFETY_SCALE = 0.96;
  runtime.BUBBLE_FONT_SAFETY_SCALE = BUBBLE_FONT_SAFETY_SCALE;
  const BUBBLE_FONT_VERTICAL_SAFETY_SCALE = 0.92;
  runtime.BUBBLE_FONT_VERTICAL_SAFETY_SCALE = BUBBLE_FONT_VERTICAL_SAFETY_SCALE;
  const BUBBLE_FONT_ORIGINAL_SCALE = 1.08;
  ...
  const state = {
    ...
    floatingBall: null,
    floatingTextBall: null,
    floatingImageBall: null,
    floatingNovelBall: null,
    floatingComicBall: null,
    floatingWebpageBall: null,
    floatingBallClose: null,
    floatingBallFeedback: null,
    floatingMenu: null,
    floatingMenuOpen: false,
    novelProgressPanel: null,
    novelProgressElements: null,
    novelProgressHideTimer: 0,
    webpage: null,
    sourceLanguage: "auto",
